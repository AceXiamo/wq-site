  ...
  >
    ...
    >
      ...
      <div class="flex flex-col gap-[5px] flex-auto w-0">
        <span class="max-md:text-[12px] truncate overflow-hidden">🎥【 {{ item.title }} 】</span>
        <div class="flex gap-[10px]">
          <span class="text-gray-400 text-[11px] max-md:text-[10px]">Time:</span>
          <span class="text-gray-400 text-[11px] truncate overflow-hidden max-md:text-[10px]">{{ item.begin }}</span>
        </div>
        <div class="flex gap-[10px]">
          <span class="text-gray-400 text-[11px] max-md:text-[10px]">Size:</span>
          <span class="text-gray-400 text-[11px] truncate overflow-hidden max-md:text-[10px]">{{
            byte2GB(item.size!)
          }}</span>
        </div>
      </div>
